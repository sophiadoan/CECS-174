...
def get_price(input_price):
    ...
    while True:
        ...
        if input_price < 0: 
            ...
            item_price = input("Enter the purchase price (xx.xx) or 'q' to quit: ")
...
def calculate_refund(payment_due):
    ...
    refund = float(item_price) - float(-1 * payment_due) # not correct; refunding the payment due not the depositted money 
    global quarters
    global dimes 
    global nickels
